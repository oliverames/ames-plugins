...
Applies Blue Cross VT brand styles to the simple fallback pandoc reference.docx
using python-docx. The default BCBS Word template is
reference-proposal-report.docx, generated by style-proposal-report.py.
...
def main():
    ...
    print(f"\n✓ Saved: {OUTPUT_PATH}")
    print()
    print("The simple fallback reference.docx is ready for use with pandoc.")
    print("Run: build-letterhead.sh --template=simple your-document.md output.docx")
