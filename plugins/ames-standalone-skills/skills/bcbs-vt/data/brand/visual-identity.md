# BCBS VT Visual Identity Reference
...
- Use Bold weight for page titles and major section headers
- Use Regular or Demi for subheads and secondary headlines
- Available via Adobe Fonts / Linotype license
...
**Logo Assets (from Brandfetch CDN):**
- SVG (dark theme): `https://cdn.brandfetch.io/idlq2tlHcW/theme/dark/logo.svg`
- PNG (820×179, dark): `https://cdn.brandfetch.io/idlq2tlHcW/w/820/h/179/theme/dark/logo.png`
- Icon/Shield only: `https://cdn.brandfetch.io/idlq2tlHcW/w/1885/h/1885/theme/dark/icon.jpeg`

**Logo usage guidelines (standard BCBS rules):**
- Never stretch, rotate, or alter the logo
- Maintain clear space of at least 1× the logo height on all sides
- On dark backgrounds: use white/reversed version
- On light backgrounds: use full-color version
- Minimum size: ~120px wide for digital; ~1 inch for print
- Never place the logo on a photographic background without a white box behind it

**"An Independent Licensee of the Blue Cross and Blue Shield Association"**
- This line is required on all official external communications
- Typically appears in small text below the logo

---

## Design Principles

1. **Clean and open** — White space is intentional. Don't crowd layouts.
2. **Vermont imagery** — Mountains, forests, seasons, outdoor recreation, community gatherings. Avoid generic stock photography.
3. **People first** — Real Vermonters over models. Authentic, candid photography preferred.
4. **Accessible** — WCAG AA contrast ratios minimum. Captions on all video. Alt text on all images.
5. **Seasonal** — Content and design should reflect Vermont's four seasons (outdoor events change accordingly).
