...
description: This skill should be used when the user asks to "humanize text",
  ...
  this more natural", or needs to remove signs of AI-generated writing. Detects
  and fixes 24 pattern categories including inflated symbolism, promotional
  language, AI vocabulary, em dash overuse, and sycophantic tone.
allowed-tools:
  - Read
  - Write
  - Edit
