...
name: swiftpm-macos
description: >-
  Build, run, and test pure SwiftPM-based macOS packages and executables.
when_to_use: >-
  Repo is package-first, there is no Xcode project, or Swift package
  workflows are the fastest path to diagnosis.
---
