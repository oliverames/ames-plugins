---
name: test-macos-app
description: Run the smallest meaningful macOS test scope and explain failures by category. Use when running tests for a macOS Xcode project or SwiftPM package.
