...
description: Inspect a macOS signing or entitlement failure and explain the minimum fix path. Use when codesign, spctl, or notarization fails during a macOS app build or distribution workflow.
