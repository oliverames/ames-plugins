...
description: Best practices and example-driven guidance for building iOS SwiftUI views and components, including navigation hierarchies, custom view modifiers, and responsive layouts. Use when creating or refactoring iOS SwiftUI UI, designing tab architecture with TabView, composing screens with VStack/HStack, managing @State or @Binding, or needing iOS-specific component patterns. For macOS SwiftUI, use swiftui-patterns instead.
---
